...
def compute_feasibility(dataset):
    objs = dataset.obj_str_list
    attrs = dataset.attr_str_list
    ...
    for a in attrs:
        print('Attribute', a)
        for o in objs:
            if (a, o) not in dataset.train_pair_str_list:
                idx = dataset.dict_AllPair2IDX[(a, o)]
                score_obj = get_pair_scores_objs(
                    a,
                    o,
                    dataset.obj_str_list,
