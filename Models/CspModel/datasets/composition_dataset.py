...
class CompositionDataset(Dataset):
    def __init__(
        ...
        self.attrs, self.objs, self.all_pairs, \
                self.train_pairs, self.val_pairs, \
                self.test_pairs = self.parse_split()

        if self.open_world:
            self.all_pairs = list(product(self.attrs, self.objs))
        ...
        self.allPair2idx = {pair: idx for idx, pair in enumerate(self.all_pairs)}
    ...
    def get_split_info(self):
        ...
        for instance in data:
            ...
            if attr == 'NA' or (attr,
                                obj) not in self.all_pairs or settype == 'NA':
    ...
    def __getitem__(self, index):
        ...
        if self.phase == 'train':
            ...
            data = [
                img, self.attr2idx[attr], self.obj2idx[obj], self.allPair2idx[(attr, obj)]
            ]
